  ...
  return (
    <section id="processo" className="relative overflow-hidden px-6 pt-10 pb-20">
      ...
      <div className="relative z-20 mx-auto max-w-md">
        <Reveal dir="up">
          <h2 className="font-grandenhas text-center text-7xl leading-tight text-white drop-shadow-sm">
            Como a arte chega
            <br />
            até a sua casa
          </h2>
  ...
  return (
    <footer className="bg-dark px-6 pb-12 pt-4 text-center text-creme">
      <div className="mx-auto max-w-md border-t border-creme/10 pt-10">
        <a href="/">
          <img src="/logo-iara.png" alt="Iara Vida" className="mx-auto h-24 w-auto" style={{ filter: "brightness(10) sepia(1) saturate(0)" }} />
        </a>
